...
from simulation.openfoam.system_dir import control_dict, fv_solution_dict, fv_schemes_dict
from simulation.openfoam.constant_dir import transport_properties_dict, turbulence_properties_dict
...
def prepare_openfoam_case(working_path: Path, case_name: str, airfoil: Airfoil, setup: Settings) -> None:
    """
...
def create_meshing_files(case_path: Path, airfoil: Airfoil, setup: Settings, mesher: str) -> None:
    """
